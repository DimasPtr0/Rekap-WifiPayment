<?php
// Kode untuk menghasilkan password acak
$pass_acak = mt_rand(1000, 9999);

// Mendapatkan ID pelanggan terakhir dari database dan mengatur format ID pelanggan baru
                ...
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" id="id_pelanggan" name="id_pelanggan" value="<?php echo $format; ?>" readonly/>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <select name="id_paket" id="id_paket" class="form-control select2" style="width: 100%;">
                                    ...
                                    <option value="<?php echo $row['id_paket'] ?>">
                                        <?php echo $row['paket'] ?> | <?php echo rupiah($row['tarif']); ?>
                                    </option>
                                    <?php
                                    }
                                    ?>
