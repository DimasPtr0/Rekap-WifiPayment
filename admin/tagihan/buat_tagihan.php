						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped">
								...
								<tbody>
									<?php
										$no = 1;
										$sql = $koneksi->query("SELECT p.id_pelanggan, p.nama, k.paket, k.tarif FROM tb_pelanggan p INNER JOIN tb_paket k ON p.id_paket=k.id_paket ORDER BY id_pelanggan");
										while ($data = $sql->fetch_assoc()) {
									?>
									<tr>
										<td><?php echo $no++; ?></td>
										<td>
											<input type="text" name="id_pelanggan[]" id="id_pelanggan" class="form-control" value="<?php echo $data['id_pelanggan']; ?>" readonly>
										</td>
										<td>
										...
										<td>
											<input type="text" name="tarif[]" id="tarif" class="form-control" value="<?php echo $data['tarif']; ?>" readonly>
										</td>
									</tr>
									<?php
										}
