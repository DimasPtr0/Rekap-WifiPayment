...
<head>
	...
	<title>Aplikasi MEGADATA ISP</title>
	<link rel="icon" href="dist/img/megadata.png">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">
					<marquee>
						<b>APLIKASI TAGIHAN MEGADATA ISP</b>
					</marquee>
				</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										APLIKASI TAGIHAN MEGADATA ISP (PAKET BULANAN)
									</b>
								</span>
							</a>
						</li>
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="dist/img/megadata.png" class="" alt="User Image">
					</div>
      ...
      if(isset($_GET['page'])){
		...
		<footer class="main-footer">
			...
			<center>
				...
				<a href="https://megadata.net.id/">MEGADATA ISP</a></strong> | 2024
			</center>
		</footer>
